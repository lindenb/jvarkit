...
public class GenomicJasparTest extends TestUtils {
	...
	public void test01(final String ref) throws IOException {
    	final File output = super.createTmpFile(".bed");
        ...
        Assert.assertEquals(new GenomicJaspar().instanceMain(new String[]{
        		"-o",output.getPath(),
        		"-J",matrixFile.getPath(),
        		ref
        	}),0);
        super.assertIsBed(output);
    	}
}
