...
@XmlRootElement(name = "GBSeq_feature-table")
public class GBSeqFeatureTable {
     ...
     * This is why there is not a <CODE>set</CODE> method for the gbFeature property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the gbFeature property.
     */
    public List<GBFeature> getGBFeature() {
        if (gbFeature == null) {
            gbFeature = new ArrayList<>();
        }
