...
public class MedlineCitationSet {
     ...
     * This is why there is not a <CODE>set</CODE> method for the medlineCitation property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the medlineCitation property.
     */
    public List<MedlineCitation> getMedlineCitation() {
        if (medlineCitation == null) {
            medlineCitation = new ArrayList<>();
        }
