...
public class BatchIGVPictures extends JFrame
	...
	private Slave currentSlave=null;
	...
	private class Slave
		...
		public void run()
			...
			File htmlFileOut=new File(pathOut+".html");
			File pngFile=null;
		...
		private void log(final String labelStr)
			{
			try {
