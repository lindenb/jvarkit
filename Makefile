...
dtd-insdseq:
	./xjc -nv -d src/main/java -p com.github.lindenb.jvarkit.ncbi.schema.insdseq -dtd  "https://www.ncbi.nlm.nih.gov/dtd/INSD_INSDSeq.dtd"

dtd-gb:
	./xjc -nv -d src/main/java -p com.github.lindenb.jvarkit.ncbi.schema.gb -dtd   "https://www.ncbi.nlm.nih.gov/dtd/NCBI_GBSeq.dtd"

xsd-uniprot:
	./xjc -nv -d src/main/java -p com.github.lindenb.jvarkit.uniprot.schema "https://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/uniprot.xsd"
